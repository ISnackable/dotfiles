...
require("awful.hotkeys_popup.keys") -- TMUX hotkeys
...
-- Menu
-- Create a launcher widget and a main menu -- MOVE TO `noodle` directory later
myawesomemenu = {
...
root.buttons(keys.mousebuttons) -- Mouse bindings
